...
I'm going to build on my [last post](/posts/micrograd/), which walked through extending Andrej Karpathy's micrograd to vector math, so I'll illustrate simple implementations of some custom reverse-mode rules using [my fork of micrograd](https://github.com/jcallaham/micrograd).
...
* [**Part 5:**](/posts/custom-ad-part-5/) Putting it all together: differentiating constrained optimization
...
<img src="/images/autodiff/propagators.jpeg" alt="Propagators" width="400" style="display: block; margin: 0 auto" />
...
<img src="/images/autodiff/pushforward.jpeg" alt="Pushforward" width="400" style="display: block; margin: 0 auto" />
...
<img src="/images/autodiff/pullback.jpeg" alt="Pullback" width="340" style="display: block; margin: 0 auto" />
...
This is laying some groundwork for [Part 2](/posts/custom-ad-part-2/), where we'll see how to generalize the Jacobian, JVP, and VJP to functions that operate on all kinds of different inputs.
