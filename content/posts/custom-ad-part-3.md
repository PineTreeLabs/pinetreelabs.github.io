...
In [Part 2](/posts/custom-ad-part-2/) we took a step back to learn about linear maps, their adjoints, and how this relates to automatic differentiation.
...
We'll need to know how to derive the tangent linear map (which we covered this time), and we'll need to know how to work with their adjoints as well, which we introduced in a pretty abstract way in [Part 2](/posts/custom-ad-part-2/).
